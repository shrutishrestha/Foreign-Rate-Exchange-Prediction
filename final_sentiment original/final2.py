...
def calculate_prf(test_original,tp,tn,fp,fn):
    ...
    plt.stem(testing)
    plt.text(0,2.6,'Accuracy =' + str("{0:.4f}".format(round(accuracy,4))) + '  positive precision ' + str("{0:.4f}".format(round(pos_precision,4))) +  '  negative precision =' + str("{0:.4}".format(round(neg_precision,4))) +  '  positive recall = ' + str("{0:.4f}".format(round(pos_recall,4))) + '  negative recall =' + str("{0:.4f}".format(round(neg_recall,4))) + '\n  positive F-measure =' +str("{0:.4f}".format(round(pos_F,4))) + '  negative F-measure=' +str("{0:.4f}".format(round(neg_F,4))))
